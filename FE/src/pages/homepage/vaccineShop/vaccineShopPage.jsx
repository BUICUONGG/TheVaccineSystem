                  ...
                  >
                    {selectedCategory === "Single" ? (
                      ...
                      <>
                        ...
                        <button onClick={handleMoreInfo()} className="view-more-btn">XEM THÊM</button>
                      </>
                    ) : (
                      // Package display
                      <>
                        ...
                        <button onClick={() => navigate(`/vaccineDetail/${vaccineId}`)} className="view-more-btn">XEM THÊM</button>
                      </>
                    )}
                  </div>
                ))}
