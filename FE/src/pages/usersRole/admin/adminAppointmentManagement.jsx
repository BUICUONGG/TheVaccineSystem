...
const AdminAppointmentManagement = () => {
  ...
  const fetchAppointments = async () => {
    try {
      ...
      const responseGoi = await axiosInstance.get("/appointmentGoi/showInfo", {
        headers: { Authorization: `Bearer ${token}` },
      });
          ...
          if (appointment.cusId) {
            try {
              const customerResponse = await axiosInstance.get(
                `/customer/getone/${appointment.cusId}`,
                { headers: { Authorization: `Bearer ${token}` } }
              );
              return {
                ...appointment,
        ...
        if (record.vaccinePakageId) {
          try {
            const packageResponse = await axiosInstance.get(
              `/vaccinepackage/getone/${record.vaccinePakageId}`,
              { headers: { Authorization: `Bearer ${token}` } }
            );
        ...
        if (!record.doseSchedule) {
          try {
            const appointmentResponse = await axiosInstance.get(
              `/appointmentGoi/getone/${record._id}`,
              { headers: { Authorization: `Bearer ${token}` } }
            );
        ...
        if (!record.customer || !record.vaccine) {
          ...
          try {
            const detailResponse = await axiosInstance.get(
              `/appointmentLe/getdetailaptlee/${record._id}`,
              { headers: { Authorization: `Bearer ${token}` } }
            );
  ...
  const filteredAppointmentsLe = appointmentsLe.filter((appointment) => {
    ...
    const customerName =
      appointment.customer?.customerName?.toLowerCase() || "";
  ...
  const filteredAppointmentsGoi = appointmentsGoi.filter((appointment) => {
    const searchLower = searchText.toLowerCase();
    const customerName =
      appointment.customerDetails?.customerName?.toLowerCase() || "";
    const appointmentId = appointment._id?.toLowerCase() || "";
      ...
      return (
        <div className="appointment-details">
          ...
          <div className="detail-row">
            ...
            <div className="detail-value id-column">
          ...
          <div className="detail-row">
            ...
            <div className="detail-value">
              {selectedAppointment.customerDetails?.customerName || "N/A"}
            </div>
          </div>
          ...
          <div className="detail-row">
            ...
            <div className="detail-value">
              {selectedAppointment.packageName || "N/A"}
            </div>
          </div>
          ...
          <div className="detail-row">
            ...
            <div className="detail-value">
              <Select
                ...
                style={{ width: 140 }}
                onChange={(value) =>
                  handleStatusChange(selectedAppointment._id, value, true)
                }
              >
                <Option value="pending">Đang chờ</Option>
                <Option value="approve">Đã duyệt</Option>
      ...
      return (
        <div className="appointment-details">
          ...
          <div className="detail-row">
            <div className="detail-label">Địa chỉ:</div>
            <div className="detail-value">
              {selectedAppointment.customer?.address || "N/A"}
            </div>
          </div>
          ...
          <div className="detail-row">
            ...
            <div className="detail-value">
              {selectedAppointment.vaccine?.vaccineName || "N/A"}
            </div>
          </div>
          ...
          <div className="detail-row">
            ...
            <div className="detail-value">
              <Select
                ...
                style={{ width: 140 }}
                onChange={(value) =>
                  handleStatusChange(selectedAppointment._id, value, false)
                }
              >
                <Option value="pending">Đang chờ</Option>
                <Option value="approve">Đã duyệt</Option>
